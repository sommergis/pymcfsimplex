...
class MCFClass(_object):
    ...
    def LoadNet(self, nmx=0, mmx=0, pn=0, pm=0, pU=0, pC=0, pDfct=0, pSn=0, pEn=0): return _pyMCFSimplex.MCFClass_LoadNet(self, nmx, mmx, pn, pm, pU, pC, pDfct, pSn, pEn)
...
class MCFSimplex(MCFClass):
    ...
    def LoadNet(self, nmx=0, mmx=0, pn=0, pm=0, pU=0, pC=0, pDfct=0, pSn=0, pEn=0): return _pyMCFSimplex.MCFSimplex_LoadNet(self, nmx, mmx, pn, pm, pU, pC, pDfct, pSn, pEn)
